            ...
            <div className="hidden md:flex md:w-64 md:flex-col md:fixed md:inset-y-0 border-r border-accents-2">
                ...
                <div className="flex-1 flex flex-col min-h-0 bg-accents-0">
                    <div className="flex-1 flex flex-col pb-4 overflow-y-auto">
                        ...
                        <h1 className="my-3 text-center text-lg font-bold text-white/90">AI Study Assistant</h1>
                        ...
                        {/* <span className="font-medium text-gray-400 text-sm px-2 pt-3">History</span>
